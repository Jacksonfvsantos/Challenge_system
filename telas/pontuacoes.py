...
def tela_pontuacoes():
    ...
    # --- ABA: PROFESSOR (Acompanhamento e Auditoria de Líderes) ---
    if tipo == "professor":
        with aba_prof:
    ...
    with aba_aluno:
        ...
        if not dash.get("sucesso"):
            ...
            # 1. Cards com os Indicadores em Destaque do Relatório
            ...
            # 2. Gráfico de Evolução ao Longo do Tempo (Requisito de UX do Relatório)
            ...
            # 3. Caixa de Incentivos Acadêmicos
